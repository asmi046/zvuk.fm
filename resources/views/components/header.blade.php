	...
	<div class="_container">
		...
		<div class="header_row top_row">
            ...
            <ul class="header__menu-list menu-list d-flex">
				<li><a href="{{route('roliki')}}"><span class="_audioroliki"></span>Аудиоролики</a></li>
				<li><a href="{{route('diktors')}}"><span class="_dictors"></span>Дикторы</a></li>
				<li><a href="{{route('chrono')}}"><span class="_chrono"></span>Хронометраж</a></li>
				<li><a href="{{route('pay')}}"><span class="_pay"></span>Оплата</a></li>
        ...
        <div class="header_row bottom_row">
            <a href="{{route('hove_work')}}" class="buttons-header__btn btn">Как начать работу</a>
			<a href="{{route('advantages')}}" class="buttons-header__btn btn">Преимущества</a>
			<a href="{{route('pogoda')}}" class="buttons-header__btn btn">Радио прогноз погоды</a>
			<a href="{{route('privet')}}" class="buttons-header__btn btn">Голосовые приветствия</a>
        </div>
